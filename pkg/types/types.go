...
type IPPointerReservation struct {
	NetworkName string `json:"networkname"`
	IPPointer   net.IP `json:"IPPointer"`
}

func (irr IPPointerReservation) String() string {
	return fmt.Sprintf("tupt18 IPPointer: %s has the current pointer: %s", irr.NetworkName, irr.IPPointer.String())
}
