...
type mockedPool struct {
	...
	ippointers []types.IPPointerReservation
}
...
func (mp *mockedPool) GetPointer() []types.IPPointerReservation {
	return mp.ippointers
}

func (mp *mockedPool) Update(context.Context, []types.IPReservation, []types.IPPointerReservation) error {
	return nil
}
